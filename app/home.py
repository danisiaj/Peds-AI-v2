...
def login():
    ...
    with st.expander(label='Log in instructions'):
        ...
        st.info("""This APP integrates almost all the concepts learned in my Data Science & Machine Learning Bootcamp through IronHack.
            ...
            \n Login info: username/last name = 'user'\n 
                password/MRN = 12345
            \n Enjoy!       
